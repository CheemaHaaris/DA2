...
## Data Collection  # mention general pattern or pop in external validity part
...
Data was collected from three different sources for this analysis. Firstly, the data on the premier league (football) was obtained from https://footystats.org/england/premier-league in a csv format. Next, data was collected manually to identify the city for each team (20 obs, 2 variables) and this was joined with the football data. Finally, weather data was collected from https://visualcrossing.com using their query builder, for each of the city in the UK which was associated with each team. 
